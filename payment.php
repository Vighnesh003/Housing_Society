...
<input type="checkbox" id="check">
    ...
    <header>
      ...
      <div class="left_area">
        <h3>Yashogad<span>&nbsp;Society</span></h3>
      </div>
                ...
                <div class= "paycontainer">
                    ...
                    <form action="#" method="POST">
                        <div class="payform">
				            ...
				            <br><br>
                            <input type="text" class="field" name="ptitle" placeholder="<?php echo $_SESSION['username']?>" readonly>
                            <input type="number" class="field" name="pflat" placeholder="<?php echo $_SESSION['flatno']?>" readonly>
                            <input type="number" class="field" name="pamount" placeholder="₹ Enter Your Amount" min="500" required><br>
...
if(isset($_POST['ppaymnet'])){
    $connection = mysqli_connect("localhost","root","","userimage","3308");
    $db = mysqli_select_db($connection,"userimage");
    $query = "insert into payrecords values(null,'$_SESSION[username]','$_SESSION[flatno]','$_POST[pamount]','Success')";
