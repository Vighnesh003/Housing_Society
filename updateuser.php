...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST" >
            ...
            <input type="number" placeholder="Flat-No." name="flatno" value="<?php echo $row['Flatno'] ?>" min="1" required>
            <input type="tel" placeholder="Mobile Number" name="mobno" value="<?php echo $row['MobileNo'] ?>" pattern="[6-9]{1}[0-9]{9}" required>
