            ...
            <div class="right box">
                ...
                <div class="content">
                    <div class="place">
                        ...
                        <span class="text">Yashogad society, pandurang wadi,near sai baba mandir,Dombivli(E)</span>
                    </div>
                    <div class="phone">
                    ...
                    <div class="email">
                        ...
                        <span class="text">Yashogadsociety@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
...
if(isset($_POST['logina'])){
    ...
    if($user=="Shubhash_Ingale" && $adcode=="100"){
